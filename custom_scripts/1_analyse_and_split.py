...
lesion_analysis_results = []
for case_id in tqdm(all_ids):
    case_mask = nib.load(TRAIN_LABELS_DIR / (case_id + TERMINATION))
    ...
    lesion_analysis_results.append(case_results)

lesions_analysis = pd.DataFrame.from_records(lesion_analysis_results)
# Filling NAs:
cols_w_possible_NAs = [
